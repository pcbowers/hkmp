...
RUN curl -sLo /opt/app/HkmpPouch.dll https://github.com/Extremelyd1/HKMP/releases/download/v2.1.0/https://github.com/PrashantMohta/HkmpPouch/releases/download/v0.3.0/HkmpPouch.dll
